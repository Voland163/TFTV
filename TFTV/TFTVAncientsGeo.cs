...
namespace TFTV
{
    internal class TFTVAncientsGeo
    {
        ...
        internal class AncientSites
        {
            ...
            internal static void OnTakingAncientSiteFromAncients(GeoMission geoMission)
            {
                try
                {
                    ...
                    if (geoMission.MissionDef.SaveDefaultName == "AncientRuin" && !geoMission.MissionDef.Tags.Contains(ancientSiteDefense))
                    {
                        ...
                        List<GeoVehicle> geoVehicles = geoMission.Site.Vehicles.ToList();
        ...
        internal class AncientsResearch
        {
        ...
        internal class ExoticResources
        {
        ...
        internal class DefendCyclopsStoryMission
        {
            ...
            internal static void OnCompletingDefendCyclopsMission(GeoMission geoMission, FactionResult viewerFactionResult)
            {
                ...
                try
                {
                    ...
                    if (geoMission.MissionDef.Tags.Contains(ancientSiteDefense))
                    {
                        if (viewerFactionResult.State == TacFactionState.Won)
                        {
                            if (controller.EventSystem.GetVariable("Sphere") == 0)
                            {
                                ...
                                AncientsResearch.AncientsCheckResearchState(controller);
                            }
                        ...
                        geoMission.Site.Owner = controller.PhoenixFaction;
                    }
