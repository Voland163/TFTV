    ...
    internal class TFTVHarmonyTactical
    {
        ...
        public static class TacticalVoxelMatrix_StartTurn_Patch
        {
            public static void Postfix(TacticalVoxelMatrix __instance, TacticalVoxel[] ____voxels)
            {
                ...
                try
                {
                    AircraftReworkTacticalModules.MistRepeller.ImplementMistRepellerTurnStart(__instance, ____voxels);
                    TFTVIncidents.AffinityTacticalEffects.ComputeTacticalBenefits.RefreshDeliriumPerceptionBonus(__instance.TacticalLevel);
                }
                catch (Exception e)
                {
                    TFTVLogger.Error(e);
        ...
        public static class TFTV_TacticalFactionVision_OnFactionStartTurn_Patch
        {
            public static void Postfix(TacticalFactionVision __instance)
            {
                try
                {
                    ...
                    FactionPerks.DieHardOnFactionStartTurn(__instance.Faction);
                    AircraftReworkTacticalModules.EveryTurn.ImplementModuleEffectsOnEveryPhoenixTurn(__instance.Faction);
        ...
        public static class TFTV_TacticalActor_OnAbilityExecuteFinished_patch
        {
            public static void Postfix(TacticalAbility ability, TacticalActor __instance, object parameter)
            {
                try
                {
                    ...
                    TFTVIncidents.AffinityTacticalEffects.PyschoSociolgyTacticalBenefits.ApplyRecoveryWillpowerBonus(ability, __instance);
