    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV November 6 release #2 (hotfix #3) v{MetaData.Version}";

                Logger.LogInfo("TFTV November 6 release #2 (hotfix #3)");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV November 6 release #2 (hotfix #3)");
