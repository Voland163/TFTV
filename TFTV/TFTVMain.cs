    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV June 26 release #2 (Hotfix 1) v{MetaData.Version}";

                Logger.LogInfo("TFTV June 26 release #2 (Hotfix 1)");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV June 26 release #2 (Hotfix 1)");
