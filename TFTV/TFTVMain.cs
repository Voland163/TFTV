    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV May 10 release #1 (Hotfix 2) v{MetaData.Version}";

                Logger.LogInfo("TFTV May 10 release #1 (Hotfix 2)");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV May 10 release #1 (Hotfix 2)");
