    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV April 26 hotfix release #1 v{MetaData.Version}";

                Logger.LogInfo("TFTV April 26 hotfix release #1");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV April 26 hotfix release #1");
