    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV Closed Beta October 14 release #1 v{MetaData.Version}";

                Logger.LogInfo("TFTV Closed Beta October 14 release #1");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV Closed Beta October 14 release #1");
