    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV July 3 release #2 (Hotfix 1) v{MetaData.Version}";

                Logger.LogInfo("TFTV July 3 release #2 (Hotfix 1)");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV July 3 release #2 (Hotfix 1)");
