    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV August 4 release #1 (Hotfix 1) v{MetaData.Version}";

                Logger.LogInfo("TFTV August 4 release #1 (Hotfix 1)");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV August 4 release #1 (Hotfix 1)");
