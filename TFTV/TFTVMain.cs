    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV October 29 release #1 v{MetaData.Version}";

                Logger.LogInfo("TFTV October 29 release #1 (hotfix)");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV October 28 release #1 (hotfix)");
